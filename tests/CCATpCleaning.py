...
ILC2 = ILC_simple(clusterCosmology=cc, rms_noises = noises[:5],fwhms=beams[:5],freqs=freqs[:5],lmax=lmax,lknee=lknee,alpha=alpha)
...
print  el_ilc3, err_ilc3/err_ilc, err_ilc
