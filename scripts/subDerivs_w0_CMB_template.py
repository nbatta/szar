...
#expList = ['SO-v2-6m','AdvAct']
#expList = ['SO-v2-6m-max','SO-v2-6m-min'] #,'S4-1.5-paper','S4-2.0-paper','S4-2.5-paper','S4-3.0-paper']
expList = ['S4-1.0-paper']#,'S4-2.0-paper','S4-2.5-paper','S4-3.0-paper']
calList = ['CMB_all']
#expList = ['SO-v2-6m'] #'S4-1.5-0.3','S4-1.5-0.2','S4-1.5-0.1']
#expList = ['S4-highres','S4-lowres']#'S4-1.5-0.4-0.75','S4-1.5-0.4-1.0','S4-1.5-0.4-1.25']
#expList = ['S4-1.5-0.4-0.85','S4-1.0-0.4-0.95']#'S4-1.5-0.4-0.75','S4-1.5-0.4-1.0','S4-1.5-0.4-1.25']
#expList = ['S4-1.5-0.4','S4-2.0-0.4','S4-2.5-0.4','S4-3.0-0.4']
...
for exp in expList:
    ...
    for cal in calList:
        ...
        cmd = "nohup wq sub -r \"mode:bycore;N:"+str(numCores)+";hostfile: auto;job_name: ohhaithere;priority:med\" -c \"source ~/.bash_profile ; source ~/.bashrc ; cd ~/repos/szar ; mpirun -hostfile %hostfile% python bin/makeW0Deriv.py "+exp+" "+grid+" "+cal+" "+massGridName+" \" > output"+str(time.time())+".log  &"
