...
calList = ['CMB_pol','owl1','owl2']#,'CMB_pol','owl1','owl2']
...
#fishList = ['mnu-w0-wa-paper']#,'mnu','w0']#,'w','mnu-w']#,'mnu-cvltau','w-cvltau','mnu-w-cvltau','mnu-notau','w-notau','mnu-w-notau']
fishList = ['mnu-w0-paper']#,'mnu','w0']#,'w','mnu-w']#,'mnu-cvltau','w-cvltau','mnu-w-cvltau','mnu-notau','w-notau','mnu-w-notau']
