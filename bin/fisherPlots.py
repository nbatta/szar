...
cmbfisher5 = getFisher("SO-5m-noatm","owl2","planck_mwcdm",paramList)
...
fplots.plotPair(['mnu','w0'],['cmb5','cmb6','cmb7'],labels=['SO-5m no-atm','SO-6m noatm', 'SO-7m noatm'],saveFile="output/socompowl.png")
