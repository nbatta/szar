...
for expName in expList: #[ "S4-1.0-paper","S4-1.5-paper","S4-2.0-paper","S4-2.5-paper","S4-3.0-paper"]:
        ...
        for fish_suff in fishall:
            ...
            for fish in fishList:
                ...
                try:
                    ...
                    print expName, cal,fish_suff,fish, margerrs['mnu']*1000.
                    performance[cal][fish_suff].append(margerrs['mnu']*1000.)
                except:
                    print expName, cal,fish_suff,fish
